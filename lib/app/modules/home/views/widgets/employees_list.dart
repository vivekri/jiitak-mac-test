...
import 'package:jiitak_mac_test/config/theme/theme_extensions/employee_list_item_theme_data.dart';
...
class EmployeeMockModel {
  ...
  const EmployeeMockModel(this.name, this.date, this.location, this.backgroundColor,
      this.imagePath);
}
