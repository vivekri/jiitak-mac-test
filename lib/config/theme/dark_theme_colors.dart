...
class DarkThemeColors {
  ...
  // SECONDARY
  static Color accentColor = const Color(0xFFEE5F40);
  ...
  static const Color iconColorActive = Color(0xFFFAAA14);
  ...
  // header containers
  static const Color headerContainerBackgroundColor = Color(0XFFEE5F40);
  ...
  //actionbar gradient
  static const Color actionbarDark = Color(0xFFFAAA14);
  static const Color actionbarLight = Color(0xFFFFD78D);
}
