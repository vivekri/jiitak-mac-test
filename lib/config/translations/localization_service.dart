...
import 'package:jiitak_mac_test/config/translations/ar_AR/ar_ar_translation.dart';
import 'package:jiitak_mac_test/config/translations/en_US/en_us_translation.dart';
import 'package:jiitak_mac_test/config/translations/zh_Hans/zh_hans_translation.dart';
...
class LocalizationService extends Translations {
  ...
  static Map<String, TextStyle> supportedLanguagesFontsFamilies = {
    ...
    'en': const TextStyle(fontFamily: 'Noto Sans JP'),
    'ar': const TextStyle(fontFamily: 'Noto Sans JP'),
    'zh': const TextStyle(fontFamily: 'Noto Sans JP'),
  };
